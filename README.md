...
# Lets run three algorithms (LogisticRegression, Random Forest, and GradientBoosting) based on the extent of data 
# and simplicity and effectiveness for the models.
